# Generated by Django 3.0.8 on 2021-01-13 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='movies', to='video.Category', verbose_name='类型')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user', to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '电影',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='messages', to='video.MovieInfo', verbose_name='电影名称')),
            ],
            options={
                'verbose_name': '留言',
